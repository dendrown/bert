...
# UPDATE: https://github.com/google-research/bert/issues/1023
...
def file_based_input_fn_builder(input_file, seq_length, is_training,
  ...
  def input_fn(params):
    ...
    # UPDATE: https://github.com/tensorflow/tpu/commit/a186c0e5881a3f7370245a46020cf94393e6d94b#diff-073fc255d4df3fdd58ff580eeb0831e9L179
    d = d.apply(
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
  ...
  with tf.compat.v1.variable_scope("loss"):
    if is_training:
      # I.e., 0.1 dropout
      # UPDATE: https://github.com/google-research/bert/pull/1089 [keep_prob=0.9]
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    if init_checkpoint:
      ...
      if use_tpu:
        ...
        def tpu_scaffold():
          tf.tcompat.v1.rain.init_from_checkpoint(init_checkpoint, assignment_map)
...
def main(_):
  #UPGRADE: https://stackoverflow.com/questions/55318626/module-tensorflow-has-no-attribute-logging
  ...
  tf.compat.v1.gfile.MakeDirs(FLAGS.output_dir)                     # UPDATE
  ...
  # UPDATE: https://github.com/google-research/bert/issues/49
